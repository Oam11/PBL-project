      ...
      errorBuilder: (context, _) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/nsskjsieit_20220920150312.png',
                  fit: BoxFit.contain,
                ),
              ),
            )
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'BLOODDONATION',
              path: 'blooddonation',
              builder: (context, params) => BlooddonationWidget(),
            ),
            FFRoute(
              name: 'More',
              path: 'more',
            ...
            FFRoute(
              name: 'VIEWPASTEVENTS',
              path: 'viewpastevents',
              builder: (context, params) => ViewpasteventsWidget(),
            ),
            FFRoute(
              name: 'corecommittees',
              path: 'corecommittees',
              builder: (context, params) => CorecommitteesWidget(),
            ),
            FFRoute(
              name: 'UPDATES',
              path: 'updates',
